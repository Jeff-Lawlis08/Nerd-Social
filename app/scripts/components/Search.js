...
export default React.createClass({
  ...
  componentDidMount(){
    store.reviews.fetch({url: 'https://api.backendless.com/v1/data/reviews?pageSize=50'});
    store.users.fetch({url: 'https://api.backendless.com/v1/data/users?pageSize=50'});
